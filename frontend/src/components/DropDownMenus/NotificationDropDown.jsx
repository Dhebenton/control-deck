...
function NotificationDropdown({}) {
    ...
    return (
        <div className='dropdown-wrap'>
            <button className="trans-button" onClick={handleOpen}>
                <img className={`icon-rotate ${open ? 'show' : 'hide'}`} src={NotificationBellIcon}/>
            </button>
            <div className={`dropdown notifications ${open ? 'open' : ''}`}>
                ...
                <div className='dropdown-block'>
                    <div className='dropdown-block-content-opacity'>
